...
if __name__ == '__main__':
    ...
    with open(output, 'w') as write_file:
        ...
        lr_ite_csv_file = open('lr_ite_hard_unipolar.csv', 'w')
        for alpha in numpy.arange(0.1, 20.0, 0.2):
            # For each iteration
            for n in range(iterations):
                ...
                for p in range(num_patterns):
                    ...
                    # Use output function
                    predicted_out[p] = unipolar_hard_activation_function(net)
                    # Calculating error
